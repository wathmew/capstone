...

{
    ...
    "trans_data": {
        "ar": {
            "train_file_input": "./data/translated_processed_data_eae/mmt-ar-translate/trans_ar_train_input.txt",
            "train_file_output": "./data/translated_processed_data_eae/mmt-ar-translate/trans_ar_train_output.txt",
            },
    },
