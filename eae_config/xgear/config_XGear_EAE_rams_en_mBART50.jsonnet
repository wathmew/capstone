...

{
    ...
    "train_file": "./data/processed_data/eae/rams_%s_mT5/train.json" % [langauge_alias[train_lang]],
    "dev_file": "./data/processed_data/eae/rams_%s_mT5/dev.json" % [langauge_alias[train_lang]],
    "test_file": "./data/processed_data/eae/rams_%s_mT5/test.json" % [langauge_alias[train_lang]],
